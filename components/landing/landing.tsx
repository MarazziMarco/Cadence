...
import { ArrowRight, CalendarDays, Wand2, Bot, ShieldCheck, Sparkles, BarChart3 } from 'lucide-react'
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container flex flex-col items-center py-24 text-center">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.18 }}
            ...
            <Link href="/login"><Button size="lg" variant="outline" className="h-12 px-7 text-base">Log in</Button></Link>
          </motion.div>
        </div>
      </section>
